...
export class MemStorage implements IStorage {
  ...
  private initializeData(): void {
    ...
    const sampleVideos: Omit<TrendingVideo, 'id' | 'createdAt'>[] = [
      ...
      { title: "How I Gained 1M Followers", platform: "youtube", views: 1500000, viralScore: 9.5, creator: "@growthhacker", category: "Marketing", thumbnailUrl: "https://images.unsplash.com/photo-1586281380349-632531db7ed4" },
      ...
      { title: "Viral TikTok Dance Explained", platform: "tiktok", views: 1340000, viralScore: 8.8, creator: "@trendspotter", category: "Entertainment", thumbnailUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b" },
    ];
