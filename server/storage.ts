...
export class MemStorage implements IStorage {
  ...
  private trendingVideos: Map<number, TrendingVideo>;
  ...
  private initializeData() {
    ...
    const sampleVideos: Omit<TrendingVideo, 'id'>[] = [
      ...
      {
        title: "30-Second Pasta Recipe That'll Blow Your Mind",
        platform: "youtube",
        views: 1500000,
        viralScore: 9.5,
        creator: "@quickrecipes",
        category: "Food",
        thumbnailUrl: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=225",
        createdAt: new Date()
      },
      {
      ...
      {
        title: "iPhone Tips You Didn't Know Existed",
        platform: "youtube",
        views: 3200000,
        viralScore: 9.8,
        creator: "@techtips",
        category: "Technology",
        thumbnailUrl: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=225",
        createdAt: new Date()
      },
      {
        ...
        thumbnailUrl: "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=225",
        createdAt: new Date()
      }
    ];
    ...
    const sampleProjects: Omit<Project, 'id' | 'createdAt' | 'updatedAt'>[] = [
      ...
      },
      {
        ...
        description: "Quick reviews of latest tech gadgets",
        status: "planning",
        progress: 25
      },
      {
        title: "Cooking Tutorials",
        description: "Easy 5-minute recipe series",
        status: "completed",
        progress: 100
      }
    ];
  ...
  async createAnalytics(analytics: InsertAnalytics): Promise<Analytics> {
    ...
    const newAnalytics: Analytics = { 
      ...
      videosPublished: analytics.videosPublished || 0,
      newFollowers: analytics.newFollowers || 0,
      platformDistribution: analytics.platformDistribution || null,
      performanceData: analytics.performanceData || null
    };
