...
*(Disclaimer: This deployment hosts the static frontend of the application. The backend server, originally run on Replit, is not active on this link. The GIF below demonstrates the complete, full-stack version.)*
